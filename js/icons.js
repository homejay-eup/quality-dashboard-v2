...
App.icons = (() => {
  ...
  return {
    ...
    // 分類設定
    settings: () => svg('<circle cx="12" cy="12" r="3"/><path d="M19.4 13.5a1.7 1.7 0 0 0 .3 1.9l.1.1a2 2 0 1 1-2.9 2.9l-.1-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.6V20a2 2 0 1 1-4 0v-.2a1.7 1.7 0 0 0-1.1-1.6 1.7 1.7 0 0 0-1.9.3l-.1.1a2 2 0 1 1-2.9-2.9l.1-.1a1.7 1.7 0 0 0 .3-1.9 1.7 1.7 0 0 0-1.6-1H4a2 2 0 1 1 0-4h.2a1.7 1.7 0 0 0 1.6-1.1 1.7 1.7 0 0 0-.3-1.9l-.1-.1a2 2 0 1 1 2.9-2.9l.1.1a1.7 1.7 0 0 0 1.9.3H10a1.7 1.7 0 0 0 1-1.6V4a2 2 0 1 1 4 0v.2a1.7 1.7 0 0 0 1 1.6 1.7 1.7 0 0 0 1.9-.3l.1-.1a2 2 0 1 1 2.9 2.9l-.1.1a1.7 1.7 0 0 0-.3 1.9V10a1.7 1.7 0 0 0 1.6 1H20a2 2 0 1 1 0 4h-.2a1.7 1.7 0 0 0-1.6 1Z"/>'),
    // 試算/計算
    calculator: () => svg('<rect x="5" y="3" width="14" height="18" rx="1.5"/><path d="M8 7h8"/><path d="M8 12h.01M12 12h.01M16 12h.01M8 16h.01M12 16h.01M16 16h.01"/>'),
    // 🕐 製表時間顯示/隱藏
    clock: () => svg('<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3.5 2"/>'),
    // 字體大小（編輯工具列）
    textSize: () => svg('<path d="M4 18 9 6l5 12M5.5 14h7"/><path d="M16 8h4M16 12h3M16 16h2"/>'),
    // 文字顏色（編輯工具列）
    palette: () => svg('<path d="M12 3c-3.6 4.2-6 7.4-6 10.3a6 6 0 0 0 12 0C18 10.4 15.6 7.2 12 3Z"/>'),
    // 🔒 登入畫面
    lock: () => svg('<rect x="5" y="10.5" width="14" height="9.5" rx="1.5"/><path d="M8 10.5V7a4 4 0 0 1 8 0v3.5"/>'),
    // 登出
    logout: () => svg('<path d="M15 4h3.5A1.5 1.5 0 0 1 20 5.5v13a1.5 1.5 0 0 1-1.5 1.5H15"/><path d="M10 8l-4 4 4 4"/><path d="M6 12h11"/>'),
  };
})();
